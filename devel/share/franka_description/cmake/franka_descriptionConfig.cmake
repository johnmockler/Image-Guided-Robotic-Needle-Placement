...
if("TRUE" STREQUAL "TRUE")
  set(franka_description_SOURCE_PREFIX /home/rnm/rnm_group_2/src/franka_ros/franka_description)
  set(franka_description_DEVEL_PREFIX /home/rnm/rnm_group_2/devel)
  ...
  set(franka_description_INSTALL_PREFIX /home/rnm/rnm_group_2/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'franka_description' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/rnm/rnm_group_2/src/franka_ros/franka_description/${idir}'.  ${_report}")
    endif()
