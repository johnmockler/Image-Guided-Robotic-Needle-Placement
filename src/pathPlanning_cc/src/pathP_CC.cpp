...
class PathPlanningCC
{
    ...
    std::vector <float> Bvec = {0.560,0.560,0.560,0.560,0.560,0.560,0.400,0.400,0.400,0.400,0.400,0.240,0.240,0.240,0.240,0.240};
    std::vector <float> Avec = {0.0,0.160,0.080,0.0,-0.080,-0.160,-0.160,-0.080,0.0,0.080,0.160,0.160,0.080,0.0,-0.080,-0.160};
