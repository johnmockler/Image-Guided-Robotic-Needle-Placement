...
bool PCGenNode::captureCloud(messages::ImageCapture::Request& req, messages::ImageCapture::Response& res)
{
    ...
    else if (req.x == true && cloudProcessed == false)
    {
        ...
        pcl::PointCloud<pcl::PointXYZ>::Ptr model_skeleton(new PointCloud<pcl::PointXYZ>);
        pcl::io::loadPCDFile<pcl::PointXYZ>("//home/suyashs/Desktop/Skeleton.pcd", *model_skeleton);
        
        for (int i=0; i < cloudList.size(); i++)
        {
            pcl::io::savePCDFile ("/home/suyashs/Desktopcapture" + std::to_string(i) + ".pcd", cloudList[i].cloud);
        }
...
void PCGenNode::stitchClouds()
{
    ...
    pcl::io::savePCDFile ("//home/suyashs/Desktop/scan0.pcd", *target);
    ...
    *scanResults = *target;
    ...
    pcl::io::savePCDFile ("/home/suyashs/Desktop/dense_scan.pcd", *target);
    ...
    for (std::size_t i = 0; i < rototranslations.size (); ++i)
    {
      ...
      if (icp.hasConverged ())
      {
        ...
        *output = *cloud + *target;
        ...
        pcl::io::savePCDFile ("/home/suyashs/Desktop/output_filtered2.pcd", *output);
      }
      else
      {
...
void PCGenNode::scaleCloud(pcl::PointCloud<pcl::PointXYZ>::Ptr cloud, float scalingFactor)
{
    ...
    *cloud = temp;
    ...
    void PCGenNode::alignTemplate(pcl::PointCloud<pcl::PointXYZ>::Ptr input_cloud, pcl::PointCloud<pcl::PointXYZ>::Ptr model_cloud)
    {
        ...
        pcl::io::savePCDFileBinary ("/home/suyashs/Desktop/alignment_output.pcd", transformed_cloud);
    }
